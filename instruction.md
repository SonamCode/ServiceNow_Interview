...
3. Whenever a new interview `.md` file is added, you MUST also parse its questions and answers and update the `index.html` Interactive Study Guide to include them in the appropriate Topic category.
